...
pub static FUNCTIONS: &[DsrvBuiltIn] = &[
    ...
    DsrvBuiltIn {
        ...
        insert_text_format: InsertTextFormat::SNIPPET,
        detail: "fix(f)",
        documentation: "Creates a recursive function from a function value.",
    },
    DsrvBuiltIn {
        label: "partial",
        kind: CompletionItemKind::FUNCTION,
        trigger_context: &["expr"],
        insert_text: "partial($1, $2)",
        insert_text_format: InsertTextFormat::SNIPPET,
        detail: "partial(f, args...)",
        documentation: "Partially applies a function to one or more arguments.",
    },
    DsrvBuiltIn {
        label: "lambda",
        kind: CompletionItemKind::SNIPPET,
        trigger_context: &["expr"],
        insert_text: "\\${1:x}: ${2:Int} -> ${3:expr}",
        insert_text_format: InsertTextFormat::SNIPPET,
        detail: "\\x: Type -> expr",
        documentation: "Creates a typed lambda expression.",
    },
    DsrvBuiltIn {
        label: "monitored_at",
        kind: CompletionItemKind::FUNCTION,
        ...
        insert_text_format: InsertTextFormat::SNIPPET,
        detail: "monitored_at(variable, node)",
        documentation: "Tests whether a variable is monitored at a distributed node.",
    },
    DsrvBuiltIn {
        label: "dist",
        kind: CompletionItemKind::FUNCTION,
        ...
        insert_text_format: InsertTextFormat::SNIPPET,
        detail: "dist(left, right)",
        documentation: "Returns the distributed-graph distance between two names.",
    },
];
